...
import com.geekbrains.lesson11.repositories.specifications.ProductSpecs;
import com.geekbrains.lesson11.services.*;
...
//    }
    ...
    public String removeProductToCart(@PathVariable("id") Long id, HttpServletRequest httpServletRequest) {
    ...
    public String setQuantityProductToCart(@PathVariable("id") Long id,
                                           HttpServletRequest httpServletRequest) {
        shoppingCartService.deleteProduct(httpServletRequest.getSession(), id);
        String referrer = httpServletRequest.getHeader("referer");
        return "redirect:" + referrer;
    }
